      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1">
            <span className="text-xl font-bold text-white tracking-tighter">AERIQ</span>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/25">
              <li className="hover:text-white/50 transition-colors cursor-pointer">Aeriq Purifier</li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/25">
              <li className="flex items-center gap-2.5">
                <Mail className="w-3.5 h-3.5 text-white/20" /> info@aeriq.in
              </li>
              <li className="flex items-center gap-2.5">
        ...
        <div className="border-t border-white/[0.05] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-white/20 text-xs">
            © {new Date().getFullYear()} Aeriq — Matiyari Technology Pvt. Ltd. All rights reserved.
          </p>
